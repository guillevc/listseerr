...
export class TestJellyseerrConnectionUseCase {
  constructor(
    private readonly connectionTester: IJellyseerrConnectionTester
  ) {}

  async execute(command: TestJellyseerrConnectionCommand): Promise<TestJellyseerrConnectionResponse> {
